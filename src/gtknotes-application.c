...
{
  return g_object_new (GTKNOTES_TYPE_APPLICATION,
...
static void
gtknotes_application_finalize (GObject *object)
{
...
static void
gtknotes_application_activate (GApplication *app)
{
  GtkWindow *window;
  ...
  if (window == NULL)
    window = g_object_new (GTKNOTES_TYPE_WINDOW,
                           "application", app,
                           NULL);
...
static void
gtknotes_application_class_init (GtknotesApplicationClass *klass)
{
...
static void
gtknotes_application_show_about (GSimpleAction *action,
                                 GVariant      *parameter,
                                 gpointer       user_data)
{
...
static void
gtknotes_application_init (GtknotesApplication *self)
{
